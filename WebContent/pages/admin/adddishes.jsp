   ...
   /* function begin() {
	...
	function checkprice() {
		...
		if (/^[0-9]+(.[0-9]{1,3})?$/.test(price.value)) {
			...
			error.innerHTML = ""; btu.disabled = false;
		} else {
			/*if (formstate & 2 != 0) {
				formstate = formstate ^ 2;
			}*/
...
<body style="font-family: 微软雅黑">
	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			...
			<form action="AddDishesServlet" class="navbar-form navbar-right" method="post"
					...
					<div class="row" style="padding-top: 0px">
						<div style="width: 55%;display: inline-block;">
							<div>
								...
								<p>
								<form action="AddDishesServlet" class="form-horizontal" role="form"
									...
									<input type="hidden" value="/img/dishes/1.jpg" id="dishesImg"name="dishesImg" />
									<div class="form-group">
							...
							<div style="text-align: center;">
								...
								<div>
									...
									<form class="form-inline" role="form"
										...
										action="FileUploadServlet?path=/img/dishes" name="imgform"
										...
										<input type="button" class="btn btn-danger" value="上传图片" onclick="ajaxFileUpload()"/>
									</form>
								</div>

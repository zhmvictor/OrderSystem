...
function search() {
	...
	var begin = document.getElementById("bt").value;
	var end = document.getElementById("et").value;
	 $.ajax({
        type: "POST",
        url: "GetOperateDateServlet",
        data: {
            begin:begin,
        	end:end,
        },
        ...
        success: function (json) {
        	...
        	if(json.Arr!=""){
        		for(var i=0;i<json.Arr.length;i++){
        			var newLine = "<tr><td>" + json.Arr[i].tableId + "</td><td>" + json.Arr[i].orderEndDate
					+ "</td><td>" + json.userAccount[i] + "</td><td>" + json.Sum[i]
					+ "</td>";
			        newLine += "<td>";
			...
			table.innerHTML += newLine;
        		...
        		alert("对不起，在"+begin+" 至 "+end+"期间没有数据");
        	}
        }
    }); 
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="panel panel-danger"  style="display:none;" id="result">
					<div class="panel-heading">

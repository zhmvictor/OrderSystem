...
<div class="jumbotron"
    ...
    <div class="container">
        ...
        <p>
            <a class="btn btn-primary btn-lg" href="pages/admin/main.jsp" role="button">返回餐厅管理界面
                &raquo;</a>
        </p>
    </div>
</div>
        ...
        <div style="width: 50%;display: inline-block;">
            <div>
                ...
                <form class="form-horizontal" role="form" style="margin-top: 20px"
                      method="post" action="AddUserServlet">
            ...
            <div style="text-align: center;">
                ...
                <div>
                    ...
                    <form class="form-inline" role="form"
                          enctype="multipart/form-data" action="" name="imgform"

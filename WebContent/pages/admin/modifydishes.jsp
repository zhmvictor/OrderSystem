...
/*	var btu = document.getElementById("addbtu");
	...
	function Check(){
		var price = document.getElementById("dishesPrice");
		var errorp = document.getElementById("priceerror");
		
		var name = document.getElementById("dishesName");
		var errorn = document.getElementById("nameerror");
		...
		if(name.value!=""){
			if (/^[0-9]+(.[0-9]{1,3})?$/.test(price.value)){
				...
				errorp.innerHTML = "请输入正确的价格格式！";
				btu.disabled = "disabled";
			}
		}
		else{
			errorn.innerHTML = "菜品名必须填写！";
			btu.disabled = "disabled";
		}
	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<img src="img/faces/${USER_INFO.faceimg }" width="24" height="24" class="img-circle" style="border:1px solid #FFF" />&nbsp;&nbsp;当前用户:【${USER_INFO.userAccount}】,身份为管理员 <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li style="text-align: center;padding-top: 15px">
						<img src="img/faces/${USER_INFO.faceimg }" width="128" height="128" class="img-circle" style="border:1px solid #CCC;box-shadow:0 0 10px rgba(100, 100, 100, 1);margin-bottom: 20px" /></li>
			...
			<form class="navbar-form navbar-right" method="post" action="" target="formtarget">
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li class="nav-header" style="font-size: 18;margin-bottom: 10px;margin-left: 10px">
					<i class="icon-credit-card icon-large"></i>&nbsp;运营功能</li>
					<li><a href="toadminmain.order">
					<i class="icon-money icon-large"></i>&nbsp; 顾客结账界面
				...
				<div class="container" style="width:100%">
					<div class="row" style="padding-top: 0px">
						<div style="width: 55%;display: inline-block;">
							<div>
								<h2>请填写菜品信息：</h2>
								<p>请在下面的表单中填写需修改的菜品名称、价格等描述信息</p>
								...
								<p>
								<form class="form-horizontal" role="form" style="margin-top: 20px" method="post" action="ModifyDishesServlet">
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">名&nbsp;&nbsp;&nbsp;&nbsp;称:</label>	
										<div class="col-sm-10">
											<input type="text" class="form-control" 
											       id="dishesName"  value="${DISHES_INFO.dishesName }" 
											       size="20" name="dishesName" 
											       placeholder="请输入菜品名称" onblur="Check()">
										</div>	
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" 
											       id="dishesDiscript" value=${DISHES_INFO.dishesDiscript } 
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea rows="8" class="form-control" 
											          name="dishesTxt" placeholder="请输入少于400字的说明">${DISHES_INFO.dishesTxt }</textarea>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" 
											       id="dishesPrice" name="dishesPrice"
											       placeholder="请输入菜品价格" value="${DISHES_INFO.dishesPrice }" 
											       onblur="Check()">
										</div>
									...
									<div class="form-group">
										...
										<input type="checkbox" name="recommend" 
											       id="recommend" ${DISHES_INFO.recommend==1?"checked=\"checked\"":"" }
											       value="1" />
											        <span style="font-size: 16;font-weight: bold;">推荐菜品</span>
										</div>
										<div style="color: red;float: right;" id="priceerror"></div>
									</div>


									<input type="hidden" value="${DISHES_INFO.dishesId }" id="dishesId" name="dishesId" />
									<input type="hidden" value="${DISHES_INFO.dishesImg }" id="dishesImg" name="dishesImg" />

									<div class="form-group">
										<div class="col-sm-offset-2 col-sm-10">
											<input type="submit" class="btn btn-danger" id="addbtu" value="修改菜品" />
										</div>
									</div>
								</form>
							</div>
						...
						<div style="width: 25%;display: inline-block;vertical-align: top;">
							...
							<div style="text-align: center;">
								...
								<p style="margin-top: 15px">
									为菜品指定新的图片，请选择图片文件后，点击
									<span style="color: red;font-weight: bold;">上传图片</span>按钮
								</p>
								<div>

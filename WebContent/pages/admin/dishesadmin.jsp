...
function usersAjax(pageIndex,everyPageDataCount){//初始化数据
	$.ajax({
        type: "POST",
        url: "GetDishesInfoByPageServlet",
        data: {
        ...
        success: function (json) {
        	  ...
        	  if(json.Arr!=""){
        		var newLine = "";
      			for(var i=0;i<json.Arr.length;i++){
      				newLine += "<tr><td>" + json.Arr[i].dishesId + "</td><td>" + json.Arr[i].dishesName
					+ "</td><td>" + json.Arr[i].dishesDiscript + "<td>"
					+ json.Arr[i].dishesPrice + "</td>";
			var recommendString = json.Arr[i].recommend == "0" ? "非特色菜品" : "特色菜品";
			...
			newLine += "class='icon-cogs icon-large' title='编辑菜品信息' onclick='window.location=\"ToModifyDishesServlet?dishesId="
					+ json.Arr[i].dishesId + "\"'></i>&nbsp;&nbsp;";
...
function deleteDishes(id, name) {

	if (confirm("您真的要删除菜品【" + name + "】吗？")) {
		$.ajax({
	        type: "POST",
	        url: "DeleteDishesServlet",
	        data: {
	        	id:id
	        },
	        dataType: "json",
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="panel panel-danger">
					...
					<div style="text-align: right;">
						如果您需要在系统中添加一个新菜品，请点击右边的按钮：<a href="ToAddDishesServlet"

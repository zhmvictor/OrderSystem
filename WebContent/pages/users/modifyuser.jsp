		...
		<div class="row" style="padding-top: 0px">
			<div style="width: 50%;display: inline-block;">
				<div>
					...
					<p>
					<form class="form-horizontal" role="form" style="margin-top: 20px" method="post" action="ModifyUserServlet">
						<input type="hidden" name="userId" id="userId" value="${USER_INFO.userId}" />
						
						<div class="form-group">
							<label for="firstname" class="col-sm-2 control-label">用户名:</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="firstname" name="userAccount" placeholder="${USER_INFO.userAccount}" disabled="disabled" value="${USER_INFO.userAccount}">
							</div>
							<div style="color: red;float: right;">您的用户名由系统管理员指定，不能修改</div>
						</div>
						
						<div class="form-group">
							<label for="userOldPass" class="col-sm-2 control-label">旧密码:</label>
							<div class="col-sm-10">
								<input type="password" class="form-control" id="userOldPass" name="userOldPass" placeholder="请输入原始密码" <%--onblur="checkoldpass()"--%>>
							</div>
							<div style="color: red;float: right;" id="usererror1"></div>
						</div>

						<div class="form-group">
							<label for="userPass" class="col-sm-2 control-label">新密码:</label>
							<div class="col-sm-10">
								<input type="password" class="form-control" id="userPass" name="userPass" placeholder="请输入新密码">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="password" class="form-control" id="userPass1" name="userPass1" placeholder="请再次输入新密码" onblur="checkpass()">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" name="role" ID="role" disabled="disabled">
									<option value="1"
										<c:if test="${USER_INFO.role==1}"> selected="selected"</c:if>>餐厅管理员</option>
									<option value="2"
										<c:if test="${USER_INFO.role==2}"> selected="selected"</c:if>>厨师</option>
									<option value="3"
										<c:if test="${USER_INFO.role==3}"> selected="selected"</c:if>>点餐员</option>
								</select>
							</div>
							<div style="color: red;float: right;" id="usererror">您的角色信息由系统管理员指定，不能修改</div>
						</div>

						<input type="hidden" value="/img/faces/${USER_INFO.faceimg}" id="faceimgname" name="faceimg" />
						<div class="form-group">
			...
			<div
				...
				<div style="background-color:#CCC; width:1px;height: 580px;margin-top: 0px"></div>
			</div>
			...
			<div style="width: 40%;display: inline-block;vertical-align: top;">
				...
				<div style="text-align: center;">
					<img src="img/faces/${USER_INFO.faceimg}" id="face" width="200px" height="200px" class="img-circle" style="border:1px solid #CCC;box-shadow:0 0 10px rgba(100, 100, 100, 1);" />
